...
class ControllerExtensionModuleEntegrasyon extends Controller {
    private $error = array();
    private $entegrasyon_version = "1.8.61";
...
`n11` text NOT NULL,
`tc` text CHARACTER SET utf8 NOT NULL,
...
`pz` text CHARACTER SET utf8 NOT NULL,
...
`cargo_name` varchar(64) CHARACTER SET utf8 NOT NULL,
`cargo_number` varchar(64) CHARACTER SET utf8 NOT NULL,
`invoice_link` varchar(255) CHARACTER SET utf8 NOT NULL,
`tracking_url` varchar(255) CHARACTER SET utf8 NOT NULL,
...
`market_product_id` varchar(64) CHARACTER SET utf8 NOT NULL,
`item_id` int(11) NOT NULL,
`quantity` int(3) NOT NULL,
`list_price` float(10,2) NOT NULL,
`price` float(10,2) NOT NULL,
`kdv`       int(5) NOT NULL,
`kdv_oran`  int(3) NOT NULL,
...
`tc` varchar(64) CHARACTER SET utf8 NOT NULL,
...
`amz` varchar(64) CHARACTER SET utf8 NOT NULL
  ...
  MODIFY `variant_id` int(11) NOT NULL AUTO_INCREMENT;");
        ...
        if(!$isExists->num_rows){
            $this->runExecute("INSERT INTO `" . DB_PREFIX . "es_order_status` (`order_status_id`, `name`, `oc`, `n11`, `gg`, `ty`, `eptt`, `hb`, `cs`, `amz`) VALUES
...
`date_modified` datetime NOT NULL
        ...
        $this->runExecute("CREATE TABLE `" . DB_PREFIX . "es_invoice` (
  ...
  `order_id` int(11) NOT NULL
        ...
        $this->runExecute("ALTER TABLE `" . DB_PREFIX . "es_invoice`
  ADD PRIMARY KEY (`invoice_id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `document_id` (`document_id`);");

        $this->runExecute( "ALTER TABLE `" . DB_PREFIX . "es_invoice` MODIFY `invoice_id` int(11) NOT NULL AUTO_INCREMENT;");
