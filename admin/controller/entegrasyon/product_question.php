...
class ControllerEntegrasyonProductQuestion extends Controller
{
    ...
    public function reply_form()
    {
        ...
        if($code=='hb'){
            $data['productTitle']=$question_info['result']['product']['name'];
            $data['question_creationDate']=$question_info['result']['createdAt'];
            $messages=$question_info['result']['conversations'];

            foreach ($messages as $message) {

                $data['messages'][]=array(
                    'messageText'=>$message['content'],
                    'senderNickName'=>$message['from']=='Customer'?'Müşteri':'Siz',
        ...
        if (isset($question_info['result']['userName'])){
        ...
        if (isset($question_info['result']['text'])){
