...
//GEL
            ...
            if ($order_info) {
                ...
                $data['orders'][] = array(
                    ...
                    'store_url'        =>$this->config->get('config_secure') ? HTTP_SERVER : HTTP_SERVER,
   ...
   if($order_info['cargo_number']){
       echo $this->barcode($order_info['cargo_number']);
...
// This function call can be copied into your project and can be made from anywhere in your code
    ...
    protected function getList() {
        ...
        $data['efatura_status']=$this->config->get('easymodule_efatura_status');
        ...
        foreach ($results as $result) {
            ...
            $payment_data=unserialize($result['payment_info']);


            $ordered_products=array();
            foreach ($orderedProducts as $orderedProduct) {

                $orderedProduct['market_url']=$this->entegrasyon->getMarketPlaceUrl($result['code'], $orderedProduct['market_product_id']);
        ...
        //$data['invoice_statuses']=array('Faturalandı','Faturalanmadı','İmzalandı','İmzalanmadı');
