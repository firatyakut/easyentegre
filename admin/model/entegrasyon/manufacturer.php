...
class ModelEntegrasyonManufacturer extends Model {
    ...
    public function getManufacturers($data = array()) {
        $sql = "SELECT m.name, m.manufacturer_id,esm.n11,esm.cs,esm.hb,esm.ty,esm.eptt,esm.pz FROM " . DB_PREFIX . "manufacturer m LEFT JOIN ".DB_PREFIX."es_manufacturer esm  ON(esm.manufacturer_id=m.manufacturer_id)";
