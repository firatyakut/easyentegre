...
class ModelEntegrasyonProductTy extends Model
{
    ...
    private function szX2D($TXVl9, $sI0pK)
    {
        goto plU3H;
        xmpcP: OTBsk:
        goto XBlI8;
        ...
        goto PxajP;
        RbB1s:
        if (isset($nsFZo["\x65\162\x72\157\x72\163"]) || isset($nsFZo["\x65\162\162\157\162"])) {
            goto lD84Q;
        }
        goto e52RM;
        WNuBX:
        ...
        goto vjbKK;
        Y1Mbp:
        $Tmrzc = curl_init($o3Se9);
        goto OShM8;
        plU3H:
        $cq0ne = $this->config->get("\164\x79\137\141\x70\x69\137\x61\156\141\150\164\x61\x72\151");
        goto O11_j;
        wY2hR: lD84Q:
        goto RfWjW;
        vjbKK:
        $nsFZo = json_decode($O9ajD, true);
        goto KzzAh;
        nDUoc:
        curl_setopt($Tmrzc, CURLOPT_SSL_VERIFYPEER, false);
        goto BBbm4;
        XBlI8:
        return array("\163\x74\141\164\x75\x73" => $SCTYi, "\155\145\163\x73\141\147\145" => $Z59ef, "\162\145\x73\x75\154\x74" => $nsFZo);
        goto tj5_1;
        KzzAh:
        $Z59ef = '';
        goto IcMAd;
        ...
        goto IDwq3;
        eE2xS:
        curl_setopt($Tmrzc, CURLOPT_RETURNTRANSFER, true);
        goto UCwQr;
        OShM8:
        curl_setopt($Tmrzc, CURLOPT_URL, $o3Se9);
        goto eE2xS;
        TtgJ5:
        curl_setopt($Tmrzc, CURLOPT_SSL_VERIFYHOST, false);
        goto nDUoc;
        kX2PC: NYtcN:
        goto FJ2N5;
        gZCBP:
        ...
        goto kX2PC;
        RfWjW:
        if (isset($nsFZo["\145\x72\162\157\162\x73"])) {
            goto Ig6xw;
        }
        goto zOLtu;
        IDwq3: rhQLs:
        goto xmpcP;
        BU2rG:
        curl_setopt($Tmrzc, CURLOPT_HTTPHEADER, $Z3H4d);
        goto TtgJ5;
        WA_ow:
        if ($nsFZo["\145\162\x72\x6f\162\163"][0]) {
            goto NYtcN;
        }
        goto gZCBP;
        BBbm4:
        $O9ajD = curl_exec($Tmrzc);
        goto WNuBX;
        pDFUw:
        $o3Se9 = "\150\x74\164\160\163\x3a\x2f\x2f\x61\160\x69\x2e\164\162\145\x6e\144\171\157\x6c\x2e\143\x6f\155\x2f\x73\x61\160\x69\x67\x77\x2f\163\165\160\x70\x6c\151\x65\x72\x73\x2f" . $u5uRK . "\x2f\160\162\157\144\165\x63\x74\x73\77\141\x72\143\x68\x69\x76\145\x64\x3d\146\x61\154\x73\145\x26\x73\151\172\x65\75" . $sI0pK . "\x26\160\141\x67\x65\x3d" . $TXVl9;
        goto Y1Mbp;
        PxajP: Ig6xw:
        goto WA_ow;
        O11_j:
        $FsxOH = $this->config->get("\164\171\x5f\x61\x70\x69\x5f\163\151\x66\x72\145\x73\x69");
        goto dVfX0;
        Mi8UX:
        goto OTBsk;
        goto wY2hR;
        FJ2N5:
        foreach ($nsFZo["\145\x72\x72\157\x72\163"] as $MpGQ5) {
            $Z59ef .= $MpGQ5["\155\x65\163\x73\x61\147\145"];
            WzMeU:
        }
        goto i3Bvm;
        UCwQr:
        $Z3H4d = array("\101\165\164\x68\x6f\x72\151\x7a\141\164\151\157\156\72\x20\102\x61\x73\x69\143\40" . base64_encode("{$cq0ne}\x3a{$FsxOH}"));
        goto BU2rG;
        zOLtu:
        $Z59ef .= $nsFZo["\163\164\141\164\x75\163"];
        goto ks6BC;
        dVfX0:
        $u5uRK = $this->config->get("\x74\x79\137\x73\141\164\x69\x63\151\137\156\165\x6d\141\162\141\163\151");
        goto pDFUw;
        i3Bvm: VhYHQ:
        goto Vy1Js;
        tj5_1:
            ...
            if (count($result['result']['content']) > 0) {
                foreach ($result['result']['content'] as $item) {
                    ...
                    if ($item['rejected'] && isset($item['rejectReasonDetails'][0]['rejectReasonDetail'])) {
                        ...
                        $product['request_id'] = isset($item['batchRequestId'])?$item['batchRequestId']:'';
    ...
    public function create_category($category_id)
    {
        ...
        //  $category=json_decode(file_get_contents('https://www.opencart.gen.tr/index.php?route=api/search/get_category_info&code=ty&category_id='.$category_id),1);


        $url='https://www.opencart.gen.tr/index.php?route=api/search/get_category_info&code=ty&category_id='.$category_id;
        $ch = curl_init();

        curl_setopt($ch, CURLOPT_URL, $url);

        $category =json_decode(curl_exec($ch),1);
    ...
    function addManufacturer($brand)
    {
        ...
        if (!$query->num_rows) {
            $this->db->query("insert into  " . DB_PREFIX . "manufacturer SET name='" . $brand . "' ");
