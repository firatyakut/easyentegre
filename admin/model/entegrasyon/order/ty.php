    ...
    public function getFromMarket()
    {
        ...
        if ($is_active) {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => 'https://api.trendyol.com/sapigw/suppliers/' . $this->config->get('ty_satici_numarasi') . '/orders?size=250&orderByDirection=DESC&orderByField=PackageLastModifiedDate',
