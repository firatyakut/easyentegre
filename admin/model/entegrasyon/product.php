...
class ModelEntegrasyonProduct extends Model
{
    ...
    {
        $sql = "SELECT p.product_id,p.model,p.manufacturer_id,p.price,m.name as manufacturer, p.image,p2m.n11,p2m.cs,p2m.ty,p2m.amz,p2m.hb,p2m.eptt,p2m.pz,p.status,pd.name,p.quantity,(select count(*) from " . DB_PREFIX . "product_option where product_id=p.product_id) as total_options ";
    ...
    {
        $sql = "SELECT DISTINCT count(*) as total FROM " . DB_PREFIX . "es_market_product where `code` = '" . $data['code'] . "'";
        if (!empty($data['filter_name'])) {
                 ...
                 if (isset($data['filter_marketplace_do'])) {
                     ...
                     if ($data['filter_marketplace_do'] == 1) {
                         if ($data['filter_marketplace'] == 'n11') {
                             ...
                             $alternatif_status2 = '"sale_status";s:1';
                         ...
                         $sql2 .= " AND ( p2m." . $data['filter_marketplace'] . " LIKE '%" . $status . "%'  or  p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status . "%'  or  p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status2 . "%' )   ";


                     } elseif ($data['filter_marketplace_do'] == 2) {
                         $status = 'sale_status";i:0';
                         $alternatif_status = 'sale_status";b:0';
                         $alternatif_status2 = 'sale_status";s:0';
    ...
    public function getTotalProducts($data = array(),$for_bulk=null,$in_marketplace=false)
    {
        ...
        if (!empty($data['filter_except'])) {
            ...
            if ($in_marketplace === true){
                $sql .= " AND (p2m." . $data['filter_except'] . " !='' ) ";

            }elseif ($in_marketplace == 2){
                $sql .= " AND (p2m." . $data['filter_except'] . "!='' or  p2m." . $data['filter_except'] . " is not null or  p2m." . $data['filter_except'] . " is null or  p2m." . $data['filter_except'] . "!='') ";
            ...
            if ($data['filter_marketplace'] != '*') {
                ...
                if (isset($data['filter_marketplace_do'])) {
                    ...
                    if ($data['filter_marketplace_do'] == 1) {
                        ...
                        $sql .= " AND (p2m." . $data['filter_marketplace'] . " LIKE '%" . $status . "%'  or  p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status . "%' or p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status2 . "%' )  ";
                        ...
                        $alternatif_status = 'sale_status";b:0';
                        $alternatif_status2 = 'sale_status";s:0';
                        $astatus = 'approval_status";i:1';
                        $aalternatif_status = 'approval_status";b:1';
                        $aalternatif_status2 = 'approval_status";s:1';
                        $sql .= " AND ( p2m." . $data['filter_marketplace'] . " LIKE '%" . $status . "%'  or  p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status . "%'  or p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status2 . "%')  AND ( p2m." . $data['filter_marketplace'] . " LIKE '%" . $astatus . "%'  or  p2m." . $data['filter_marketplace'] . " LIKE '%" . $aalternatif_status . "%'  or p2m." . $data['filter_marketplace'] . " LIKE '%" . $aalternatif_status2 . "%')  ";

                    } elseif ($data['filter_marketplace_do'] == 3){
                        $status = 'approval_status";i:0';
                        $alternatif_status = 'approval_status";b:0';
                        $alternatif_status2 = 'approval_status";s:0';

                        $sstatus = 'sale_status";i:0';
                        $salternatif_status = 'sale_status";b:0';
                        $salternatif_status2 = 'sale_status";s:0';
                        $sql .= " AND ( p2m." . $data['filter_marketplace'] . " LIKE '%" . $status . "%'  or  p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status . "%'  or p2m." . $data['filter_marketplace'] . " LIKE '%" . $alternatif_status2 . "%') AND ( p2m." . $data['filter_marketplace'] . " LIKE '%" . $sstatus . "%'  or  p2m." . $data['filter_marketplace'] . " LIKE '%" . $salternatif_status . "%'  or p2m." . $data['filter_marketplace'] . " LIKE '%" . $salternatif_status2 . "%')  ";
    ...
    public function getProducts($data = array(),$for_bulk=null)
    {
        ...
        $sql = "SELECT p.product_id,p.model,p.manufacturer_id,p.price,m.name as manufacturer, p.image,p2m.n11,p2m.cs,p2m.ty,p2m.amz,p2m.hb,p2m.eptt,p2m.pz,p.status,pd.name,p.quantity,p.date_added,(select count(*) from " . DB_PREFIX . "product_option where product_id=p.product_id) as total_options ";
